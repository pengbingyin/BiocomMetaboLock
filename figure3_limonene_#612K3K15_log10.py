...
# ================== FOLDER & TUBES ==================
folder_name = "LIMK3K15_figure3"
input_dir = os.path.join("data", folder_name)
output_dir = os.path.join("output", folder_name)

desired_tubes = ['Tube_007', 'Tube_008', 'Tube_009']
time_points = ['6h', '11h', '24h', '47h', '77h', '96h']
...
print(f"Processing tubes: {desired_tubes}\n")
...
for row, time_point in enumerate(time_points):
    for col, tube in enumerate(desired_tubes):
        ...
        # X-scale: min = -1, max = 5 with ticks 0,1,2,3,4,5
